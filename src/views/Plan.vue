    ...
    <template v-slot:inner>
      <el-table :data="tableData" highlight-current-row>
        ...
        <el-table-column label="操作">
          <template #default="scope">
              ...
              <el-button type="text" @click="deletePlan(scope.row.kid)">删除</el-button>
          </template>
        </el-table-column>
      </el-table>
      <!-- 分页器 -->
      <div style="text-align: right; padding-right: 23px; padding-top: 20px">
        ...
        ></el-pagination>
          ...
          <!-- 编辑弹出层 -->
    <el-dialog title="新增" v-model="isShowEdteOrInsert" width="680px">
      <el-form ref="form" :model="formData" :rules="rules" label-width="80px">
        ...
        <div style="display:flex">
          ...
          <el-form-item label="时间" prop="timeZone">
            <div class="block">
              <el-date-picker
...
export default {
  ...
  methods:{
    ...
    getCycleTime(timer, type){
      let time = new Date((timer- 1000*60*60*8))
      switch(type){
        case 0:
        ...
        case 5:
          ...
          return "第" + (time.getMonth+1) / 3 + 1 +"季度"+ time.format("MM-dd hh:mm")
        case 6:
    ...
    // 删除任务
    deletePlan(guid){
      this.$http.delete(`/Plan/DeletePlan`, { params: { gid: guid }})
      .then(({ code, message }) => {
        this.$showMessage(code, message, ()=>{
    ...
    changeTimmer(index){
        ...
        // 周
        case 3:
          this.format = "dddd hh:mm"
          this.datetimeType = 'datetime'
          break;
        // 月
        case 4:
          this.format = "DD hh:mm"
          this.datetimeType = 'datetime'
          break;
        // 季度
        case 5:
